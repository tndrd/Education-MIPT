...
int RunTests();
# 2 "../Onegin/foperations.cpp" 2

void PrintFile(const char* name, const MyStr* lines, size_t length){

    
# 5 "../Onegin/foperations.cpp" 3 4
   (static_cast <bool> (
# 5 "../Onegin/foperations.cpp"
   name
# 5 "../Onegin/foperations.cpp" 3 4
...
# 5 "../Onegin/foperations.cpp"
   "name"
# 5 "../Onegin/foperations.cpp" 3 4
   , "../Onegin/foperations.cpp", 5, __extension__ __PRETTY_FUNCTION__))
# 5 "../Onegin/foperations.cpp"
               ;
    
# 6 "../Onegin/foperations.cpp" 3 4
   (static_cast <bool> (
# 6 "../Onegin/foperations.cpp"
   lines
# 6 "../Onegin/foperations.cpp" 3 4
   ) ? void (0) : __assert_fail (
# 6 "../Onegin/foperations.cpp"
   "lines"
# 6 "../Onegin/foperations.cpp" 3 4
   , "../Onegin/foperations.cpp", 6, __extension__ __PRETTY_FUNCTION__))
# 6 "../Onegin/foperations.cpp"
                ;
...
# 26 "../Onegin/foperations.cpp" 3 4
   (static_cast <bool> (
# 26 "../Onegin/foperations.cpp"
   arr
# 26 "../Onegin/foperations.cpp" 3 4
   ) ? void (0) : __assert_fail (
# 26 "../Onegin/foperations.cpp"
   "arr"
# 26 "../Onegin/foperations.cpp" 3 4
   , "../Onegin/foperations.cpp", 26, __extension__ __PRETTY_FUNCTION__))
# 26 "../Onegin/foperations.cpp"
              ;
...
# 47 "../Onegin/foperations.cpp" 3 4
   (static_cast <bool> (
# 47 "../Onegin/foperations.cpp"
   buffer
# 47 "../Onegin/foperations.cpp" 3 4
   ) ? void (0) : __assert_fail (
# 47 "../Onegin/foperations.cpp"
   "buffer"
# 47 "../Onegin/foperations.cpp" 3 4
   , "../Onegin/foperations.cpp", 47, __extension__ __PRETTY_FUNCTION__))
# 47 "../Onegin/foperations.cpp"
                 ;
    
# 48 "../Onegin/foperations.cpp" 3 4
   (static_cast <bool> (
# 48 "../Onegin/foperations.cpp"
   number_of_lines
# 48 "../Onegin/foperations.cpp" 3 4
   ) ? void (0) : __assert_fail (
# 48 "../Onegin/foperations.cpp"
   "number_of_lines"
# 48 "../Onegin/foperations.cpp" 3 4
   , "../Onegin/foperations.cpp", 48, __extension__ __PRETTY_FUNCTION__))
# 48 "../Onegin/foperations.cpp"
                          ;
...
# 81 "../Onegin/foperations.cpp" 3 4
   (static_cast <bool> (
# 81 "../Onegin/foperations.cpp"
   name
# 81 "../Onegin/foperations.cpp" 3 4
   ) ? void (0) : __assert_fail (
# 81 "../Onegin/foperations.cpp"
   "name"
# 81 "../Onegin/foperations.cpp" 3 4
   , "../Onegin/foperations.cpp", 81, __extension__ __PRETTY_FUNCTION__))
# 81 "../Onegin/foperations.cpp"
               ;
...
long int GetFileSize(FILE* fp){
    ...
    int seekResult = fseek(fp, 0L, 
# 102 "../Onegin/foperations.cpp" 3 4
                                  2
# 102 "../Onegin/foperations.cpp"
                                          );
    
# 103 "../Onegin/foperations.cpp" 3 4
   (static_cast <bool> (
# 103 "../Onegin/foperations.cpp"
   seekResult == 0
# 103 "../Onegin/foperations.cpp" 3 4
   ) ? void (0) : __assert_fail (
# 103 "../Onegin/foperations.cpp"
   "seekResult == 0"
# 103 "../Onegin/foperations.cpp" 3 4
   , "../Onegin/foperations.cpp", 103, __extension__ __PRETTY_FUNCTION__))
# 103 "../Onegin/foperations.cpp"
                          ;
...
const char* GET_ERROR_NAME(TREE_STATUS status){
    ...
    switch(status){
        ...
        case OK: return "OK";
        case SIZE_LESS_ONE: return "SIZE_LESS_ONE";
        case NODES_LOOPED: return "NODES_LOOPED";
        case INVALID_POINTER: return "INVALID_POINTER";
        case TOO_MANY_NODES_FOR_CURRENT_SIZE: return "TOO_MANY_NODES_FOR_CURRENT_SIZE";
        case EDGE_ALREADY_EXISTS: return "EDGE_ALREADY_EXISTS";
        case SAME_LEFT_AND_RIGHT_CHILDS: return "SAME_LEFT_AND_RIGHT_CHILDS";
        case STRAY_NODE: return "STRAY_NODE";
        case INVALID_NODE_VALUE_PTR: return "INVALID_NODE_VALUE_PTR";
        case WRONG_TREE_PTR: return "WRONG_TREE_PTR";
        case WRONG_PARENT_PTR: return "WRONG_PARENT_PTR";
...
TREE_STATUS AttachLeftNode(Node* to_attach, Node* Parent){
    ...
    check_status = ValidateTree(Parent -> tree); if (check_status != OK){ if (Parent -> tree) GraphicalDump(Parent -> tree); return check_status; }
...
# 286 "exprtree.cpp"
   "filename"
# 286 "exprtree.cpp" 3 4
   , "exprtree.cpp", 286, __extension__ __PRETTY_FUNCTION__))
# 286 "exprtree.cpp"
                   ;
